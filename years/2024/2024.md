...
* Reading (to be completed before class): chapters 1, 2, and 3 of _Tree Thinking__
...
### Jan 24 [Carl]
*Three-hour tour, Part II: MCMCMCMC. In which we talk about Bayes Theorem and MCMC*
* Reading: chapters 8 and 9 of _Tree Thinking__
* Slides: [PhyloIntro II]()
